...
public class OperadoresAritmeticos {
	...
	public static void main(String[] args) {
		...
		resultado--; //subtrai um número pós inc
		System.out.println(resultado); //printa após inc -1, 5 - 1 = 4
		
		// subtrai pós inc, ou seja 4 - 1, porém de forma pós, vai continuar 4
		System.out.println(resultado--);
		
		System.out.println(resultado); // vai agora mostrar o resultado de 4 - 1 
		
		// subtrai pré inc, ou seja ele retira antes, 3 - 1, resultando no valor 2 de forma imediata.
		System.out.println(--resultado); 
